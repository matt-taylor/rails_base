module RailsBase
  class MfaAuthController < RailsBaseApplicationController
    ...
    # GET /mfa_verify
    def _MOVED_METHOD_mfa_code
      @masked_phone = User.find(@token_verifier.user_id).masked_phone
    end

    # POST /mfa_verify
    def _MOVED_METHOD_mfa_code_verify
    ...
    def _MOVED_METHOD_resend_mfa
      ...
      session[:mfa_randomized_token] =
        RailsBase::Mfa::EncryptToken.call(user: user, expires_at: expired_at).encrypted_val
